...
$checks = [
    ...
    'rest update route' => str_contains($routes, "put('/api/v1/scheduled-downtime/{id}'"),
    'rest delete route' => str_contains($routes, "delete('/api/v1/scheduled-downtime/{id}'"),
    ...
    'safe validation error conversion' => str_contains($service, 'function validationMessage') && str_contains($service, "array_map('strval"),
