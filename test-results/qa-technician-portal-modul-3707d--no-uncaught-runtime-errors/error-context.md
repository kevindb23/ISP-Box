...
- Name: qa.spec.js >> technician portal module smoke >> pages expose basic accessible structure and no uncaught runtime errors
- Location: tests/Playwright/qa.spec.js:91:5

# Error details

```
Error: technician unlabeled controls on /technician-portal
...
- generic [active] [ref=f3e1]:
  - complementary "Primary navigation" [ref=f3e2]:
    ...
    - list [ref=f3e9]:
      - listitem [ref=f3e10]:
        - button "Workforce" [expanded] [ref=f3e11] [cursor=pointer]:
          - generic [ref=f3e13]: 
      - listitem [ref=f3e14]:
        - link "Attendance" [ref=f3e15] [cursor=pointer]:
          - /url: /staff-attendance
          - generic [ref=f3e16]: 
      - listitem [ref=f3e18]:
        - link "My Work Orders" [ref=f3e19] [cursor=pointer]:
          - /url: /technician-portal
          - generic [ref=f3e20]: 
    - generic [ref=f3e23]:
      - generic [ref=f3e24]: F
      - generic [ref=f3e25]:
        - generic [ref=f3e26]: Fox
        - generic [ref=f3e27]: TECHNICIAN
      - button "Log out" [ref=f3e29] [cursor=pointer]:
        - generic [ref=f3e30]: 
  - generic [ref=f3e31]:
    - generic [ref=f3e32]:
      - generic [ref=f3e33]:
        - button "Toggle navigation" [expanded] [ref=f3e34] [cursor=pointer]:
          - generic [ref=f3e35]: 
        - navigation "Current page" [ref=f3e36]:
          - generic [ref=f3e37]: Workspace
          - generic [ref=f3e38]: 
          - generic [ref=f3e39]: Technician Portal
      - generic [ref=f3e40]:
        - search [ref=f3e41]:
          - generic [ref=f3e42]: 
          - searchbox "Search accessible modules" [ref=f3e43]
        - button "View notifications" [ref=f3e44] [cursor=pointer]:
          - generic [ref=f3e45]: 
        - text: 
        - generic [ref=f3e46]:
          - button "Switch to dark mode" [ref=f3e47] [cursor=pointer]:
            - generic [ref=f3e48]: 
          - button "Log out" [ref=f3e50] [cursor=pointer]:
            - generic [ref=f3e51]: 
    - generic [ref=f3e53]:
      - generic [ref=f3e55]:
        - generic [ref=f3e56]:
          ...
          - heading "My Work Orders" [level=5] [ref=f3e59]
          - text: View assigned jobs, check in, start work, upload photos, and submit completion notes.
        - button " Refresh" [ref=f3e61] [cursor=pointer]:
          - generic [ref=f3e62]: 
          - text: Refresh
      - generic [ref=f3e63]:
        - generic [ref=f3e66]:
          - generic [ref=f3e67]: Assigned
          - generic [ref=f3e68]: "0"
          - generic [ref=f3e69]: Pending jobs
        - generic [ref=f3e72]:
          - generic [ref=f3e73]: In Progress
          - generic [ref=f3e74]: "0"
          - generic [ref=f3e75]: Active jobs
        - generic [ref=f3e78]:
          - generic [ref=f3e79]: Completed
          - generic [ref=f3e80]: "0"
          - generic [ref=f3e81]: Finished jobs
      - generic [ref=f3e82]:
        - generic [ref=f3e83]:
          - generic [ref=f3e84]:
            - heading "Assigned Work Orders" [level=6] [ref=f3e85]
            - text: Click view to open work order details.
          - combobox [ref=f3e86]:
        ...
        - generic [ref=f3e89]:
          - generic [ref=f3e90]: 
          - text: No assigned work orders found.
      - text:        
```
