...
$router->get('/api/v1/users/{id}/permissions', [UsersApiController::class, 'permissions']);
$router->post('/api/v1/users/{id}/permissions', [UsersApiController::class, 'updatePermissions']);
