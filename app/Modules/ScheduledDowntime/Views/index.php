...
<?php endforeach; ?>
<div class="container-fluid nx-page" data-nx-next-root="scheduled-downtime"></div>
...
<?php else: ?>
    <div class="alert alert-warning">The scheduled downtime interface is not built.</div>
<?php endif; return;
